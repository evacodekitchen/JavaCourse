...
public class LambdaExampleWithConsumer {
	public static void main(String[] args) {
		...
		List<Product> nameSearchResult = search(products, p -> p.getName().contains("bread"), p -> System.out.println(p));
	...
	private static List<Product> search(List<Product> products, Predicate<Product> productChecker, Consumer<Product> doWithProduct) {
